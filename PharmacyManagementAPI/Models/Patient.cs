...
namespace PharmacyManagementAPI.Models
{
    public class Patient
    {
        ...
        [Required]
        [StringLength(150)] 
        public string FullName { get; set; } = string.Empty; // ? makes it optional, I think it seems good to have the full name as optional because some patients might not want to provide their full name
        [Required]
        [StringLength(20)] 
